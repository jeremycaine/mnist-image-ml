...
#cos_object = cos.Object(bucket_name, mf)
#cos_object.put(Body="")
#get_bucket_contents(bucket_name)
#get_item(bucket_name, mf)
#print(file_contents)
#file = cos.Object(bucket_name, mf).get()
#print(file)
#data_to_write = file["Body"].read()
#data_to_write = model.load_model(mf)
#print("data to write", data_to_write)

#cos_object.put(Body=file_contents)
#get_item(bucket_name, mf)
# .encode("utf-8")
